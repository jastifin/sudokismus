...
generate_msgs_test() ->
    ...
    Expected4 = [{cell, cell2, has_set, 2, [{1, 1, 2, [1, 2]}, {2, 1, 2, [1, 2]}]}],
    ?assertEqual(Msgs4, Expected4  ++ [{cell, 2, has_in_col, 1, N} || N <- lists:reverse(lists:seq(1, 9))]),
    ...
    Expected5 = [{cell, cell2, has_set, 2, [{1, 1, 2, [1, 2]}, {2, 1, 2, [1, 2]}]}, {cell, cell2, has, {3, 1, 2, [3]}}],

    ?assertEqual(Msgs5, Expected5  ++ lists:reverse(
              [{cell, 2, has_in_col, 1, N} || N <- lists:seq(1, 2)] ++
